...
def savings(gross_pay, tax_rate, expenses):
    ...
    tax_equivalent = gross_pay*tax_rate
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    # Replace `pass` with your code.
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    tot_consumption = job_consumption*num_jobs
    netmaterial = str(total_material-tot_consumption)
    valueunit = netmaterial + material_units
    return valueunit
...
def interest(principal, rate, periods):
    ...
    finalvalue = int(principal + simpleinterest)
    return finalvalue
...
def body_mass_index(weight, height):
    ...
    metricweight = weight * 0.45359237
    BMI = (metricweight/metricheight**2)
    return BMI
    # ChatGPT was used to understand list referencing
